...
\begin{Verbatim}[commandchars=\\\{\}]
    ...
    \bnt{hydr_elem_data} ::=
        ...
        [ \kw{gas} , \bnt{press0} , \bnt{press_max}, \bnt{exponent} , ]
        [ \kw{weight} , \bnt{weight} , ]
        [ \kw{spring} , \bnt{spring} , \bnt{force0} , ]
        \bnt{c_disp} ,
        \bnt{c_vel} ,
        \bnt{c_acc} , 
...
wnere
\begin{itemize}
\item \nt{stroke} must be positive
\item \nt{initial\_position} must be non-negative and less than or equal to \nt{stroke}
\item \nt{loss\_in} defaults to 1.
